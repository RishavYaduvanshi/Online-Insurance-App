...
public class admin extends AppCompatActivity {
    ...
    DatabaseHelper myDb;
    TextInputEditText changename, changepass, changephone, chid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changename = findViewById(R.id.etname);
        changepass = findViewById(R.id.etpass);
        //changephone = findViewById(R.id.etphone);
        chid =  findViewById(R.id.etid);
